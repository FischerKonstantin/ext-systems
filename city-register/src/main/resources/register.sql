...
INSERT INTO cr_address (district_code, street_code, building, extencion, apartment)
VALUES (1, 1, '10', '2','121');
INSERT INTO cr_address (district_code, street_code, building, extencion, apartment)
...
INSERT INTO cr_person (sur_name, given_name, patronic, date_of_birth,
passport_seria, passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Васильев', 'Павел', 'Николаевич', '1995-03-18', '1234', '123456', '2012-04-11', null, null);

INSERT INTO cr_person (sur_name, given_name, patronic, date_of_birth,
passport_seria, passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Васильева', 'Ирина', 'Петровна', '1997-08-21', '4321', '654321', '2017-08-19', null, null);

INSERT INTO cr_person (sur_name, given_name, patronic, date_of_birth,
passport_seria, passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Васильева', 'Евгения', 'Павловна', '2016-01-11', null, null, null, '456123', '2016-01-20');

INSERT INTO cr_person (sur_name, given_name, patronic, date_of_birth,
passport_seria, passport_number, passport_date, certificate_number, certificate_date)
VALUES ('Васильев', 'Александр', 'Павлович', '2017-10-24', null, null, null, '321654', '2017-11-11');
